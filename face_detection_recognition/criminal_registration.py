...
def register(id, fileinput):
    ...
    # Setting Directory
    path = os.path.join('E:/BACKBONE/face_detection_recognition/Criminals', "temp_criminal")
    ...
    if len(no_face) > 0:
        ...
        if rowId >= 0:
            ...
            shutil.move(path, os.path.join('E:/BACKBONE/face_detection_recognition/Criminals', str(id)))
