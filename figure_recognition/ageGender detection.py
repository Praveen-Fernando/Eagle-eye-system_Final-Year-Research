    ...
    while True:
        ...
        if ret != False:
            ...
            for bbox in bboxs:
                ...
                print(age, gender)
                if (age==(8-12) and gender=="Male"):
                    print("height of the suspect is between 131cm - 153cm")
                elif(age==(15-20) and gender=="Male"):
                    print("height of the suspect is between 153cm - 160cm")
                elif (age >= (25-32) and gender == "Male"):
                    print("height of the suspect is between 160cm - 170cm")
                elif (age == (8-12) and gender == "Female"):
                    print("height of the suspect is between 130cm - 153cm")
                elif (age == (15-20) and gender == "Female"):
                    print("height of the suspect is between 153cm - 160cm")
                elif (age >= (25-32) and gender == "Female"):
                    print("height of the suspect is between 160cm - 170cm")
                else:
                    print("height is not detected")
